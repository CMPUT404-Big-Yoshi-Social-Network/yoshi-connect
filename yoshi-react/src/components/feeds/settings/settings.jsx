            ...
            <div className='pubRow'>
                ...
                <div className='pubColM'>
                    <div className='settingColM'>
                        ...
                        { newAuthor.image === "" ? <img className={'ad-pubUserImg'} src='/images/public/icon_profile.png' alt=''  width={40}/> : <img className={'ad-pubUserImg'} src={newAuthor.newImage} alt=''  width={40}/> }
                        </div>
                        <Card.Body>
