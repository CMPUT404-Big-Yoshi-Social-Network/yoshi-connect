            ...
            <Container>
                <Nav>
                    ...
                    {/* TODO: Needs to fetch username  */}
                        <img className='rn-admUserImg' alt='rn-admUser' src='/images/icon_profile.png' width={40}/>
                        <Nav.Link className='rn-user'href="/users/:username">Username</Nav.Link> 
                    </div>
                    <div className='rn-admdiv'>
                        <img className='rn-admDashImg' alt='rn-admDashImg' src='/images/icon_public_feed.png' width={25}/>
                        <Nav.Link className='rn-admdash' href="/admin/dashboard">Dashboard</Nav.Link>
                    </div>
                    <div className='rn-admdiv'>
                        <img className='rn-admAdminsImg' alt='rn-admAdminsImg' src='/images/icon_friends_feed.png' width={25}/>
                        <Nav.Link className='rn-admadmins' href="/admin/admins">Admins</Nav.Link>
                    </div>
                    <div className='rn-admdiv'>
                        <img className='rn-admUsersImg' alt='rn-admUsersImg' src='/images/icon_messages.png' width={25}/>
                ...
                <div className='rn-admdiv'>
                    <a href='/settings'>
                        <img className='rn-admCogImg' alt='rn-admCogImg' src='/images/icon_settings.png' width={40}/>
                    </a>
