...
const comment_scheme = new Schema({
    type: 'comment',
    _id: String, // http://127.0.0.1:5454/authors/9de17f29c12e8f97bcbbd34cc908f1baba40658e/posts/de305d54-75b4-431b-adb2-eb6b9e546013/comments/f6255bb01c648fe967714d52a89e8e9c
    author: Author,
    comment: String,
    contentType: String,
    published: String},
...
const comments_scheme = new Schema({
    ...
    _id: String, // "http://127.0.0.1:5454/authors/9de17f29c12e8f97bcbbd34cc908f1baba40658e/posts/de305d54-75b4-431b-adb2-eb6b9e546013/comments"
